...
//CODE HERE
function jsNinja() {
  console.log('I am a JavaSript ninja!')
}
...
//CODE HERE
function frogCoin(gold) {
  return gold / 3
}
let totalFrogs = frogCoin(30)
